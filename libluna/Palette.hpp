...
namespace Luna {
  ...
  class Palette {
    ...
    inline ColorRgb16 &rgb16At(int index) const { return colorsRgb16()[index]; }

    inline ColorRgb24 &rgb24At(int index) const { return colorsRgb24()[index]; }

    inline ColorRgb32 &rgb32At(int index) const { return colorsRgb32()[index]; }
